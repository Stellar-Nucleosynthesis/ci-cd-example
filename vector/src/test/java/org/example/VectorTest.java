...
class VectorTest {
    ...
    public void illegalDimensionValueTest(int dimensions, int accessDimension){
        assumeTrue(dimensionsSaved());
        Vector v = new Vector(dimensions);
    ...
    public void dotProductCalculationTest(){
        ...
        v1.set(0, 2); v1.set(1, -3); v1.set(2, 4.5);
        Vector v2 = new Vector(3);
        v2.set(0, 9); v2.set(1, 2.4); v2.set(2, 0);
    ...
    public void dotProductCommutativityTest(){
        ...
        v1.set(0, 2); v1.set(1, -3);
        Vector v2 = new Vector(2);
        v2.set(0, 9); v2.set(1, 2.4);
    ...
    public void sumCalculationTest(){
        ...
        expected.set(0, 11); expected.set(1, -0.6); expected.set(2, 4.5);
    ...
    public void productCalculationTest(){
        ...
        Vector expected = new Vector(3);
        expected.set(0, 5); expected.set(1, -7.5); expected.set(2, 11.25);
